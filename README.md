> 该项目虽然已推出1.0.0.4可用版本，可是ClassIsland 不知为何还是沿用 1.0.0.3 无法安装版本，加上工作日作者要上学，修复可能要等至周末，若要下载，可以往下使用 GitHub 链接至仓库下载本地文件
...
> ~~1.0.0.3本地安装会报错，马上推出1.0.0.4修复更改~~（已修复）
...
> 有的时候桌面按钮会突然置顶（还是会影响使用，后面会尝试修复）

> ~~版本号显示有问题，仍显示1.0.0.1~~ （已修复）
